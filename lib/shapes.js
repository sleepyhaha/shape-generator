...
class Circle extends Shape {
  ...
  <text x="50%" y="50%" text-anchor="middle" dominant-baseline="middle" font-size="56" font-weight="bold" fill="${this.textColour}">${this.logoText}</text>
</svg>`;
  }
}
...
class Triangle extends Shape {
  ...
  <text x="150" y="135" text-anchor="middle" dominant-baseline="middle" font-size="56" font-weight="bold" fill="${this.textColour}">${this.logoText}</text>
</svg>`;
  }
}
